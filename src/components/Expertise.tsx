  ...
  return (
    <section id="services" ref={sectionRef} className="py-32 md:py-29 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none select-none overflow-hidden opacity-[0.05]">
        <div className="absolute top-[8%] -left-10 w-[140%] h-10 rotate-3" style={{ background: "linear-gradient(90deg, transparent, var(--navy) 30%, var(--navy) 70%, transparent)" }} />
        <div className="absolute bottom-[12%] -left-10 w-[140%] h-6 -rotate-6" style={{ background: "linear-gradient(90deg, transparent, var(--navy) 30%, var(--navy) 70%, transparent)" }} />
      </div>
