  ...
  return (
    <section id="about" className="py-32 md:py-29 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none select-none overflow-hidden">
        <div className="absolute top-[5%] -left-1/4 w-[70%] h-[60%] rounded-full opacity-[0.12]" style={{ background: "radial-gradient(ellipse, var(--navy) 0%, transparent 70%)", filter: "blur(60px)" }} />
        <div className="absolute bottom-0 -right-1/4 w-[60%] h-[50%] rounded-full opacity-[0.1]" style={{ background: "radial-gradient(ellipse, var(--navy) 0%, transparent 70%)", filter: "blur(60px)" }} />
      </div>
