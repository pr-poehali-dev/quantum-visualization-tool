...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Стандартный компьютерный стол изготавливается за 3–5 недель. Сроки зависят от размера, сложности формы и загрузки мастерской. После оплаты мы сразу ставим ваш заказ в очередь и держим в курсе каждого этапа.",
  },
  {
