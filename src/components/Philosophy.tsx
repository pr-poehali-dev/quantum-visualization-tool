...
const philosophyItems = [
  ...
  },
  {
    title: "Ручная работа",
    description:
      "Каждый умный стол и компьютерный стол из дуба проходит через руки мастера. Мы не используем конвейер — только ручная обработка, шлифовка и финишное покрытие натуральными маслами.",
  },
  {
    title: "Характер дерева",
    description:
      "Сучки, текстура, живые края — мы не скрываем природу дуба, а подчёркиваем её. Купить умный стол из дуба у нас — значит получить вещь с характером, уникальную как отпечаток пальца.",
  },
  {
    title: "Вековая прочность",
    description: "Дуб — одна из самых твёрдых пород дерева. Умный стол из массива дуба, сделанный сегодня, станет семейной реликвией для следующего поколения.",
  },
]
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div className="space-y-6 lg:pt-48">
            <p className="text-muted-foreground text-lg leading-relaxed max-w-md mb-12">
              Умный стол или компьютерный стол из дуба — это больше, чем мебель. Это место, где семья собирается каждый день. Мы делаем столы из массива дуба, которые становятся центром вашего дома на десятилетия.
            </p>
