...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Да, доставляем в любой регион транспортными компаниями (СДЭК, ПЭК) или собственной доставкой по Москве и МО. Стол упаковывается в деревянную обрешётку — доедет целым даже в самый дальний уголок страны.",
  },
  {
