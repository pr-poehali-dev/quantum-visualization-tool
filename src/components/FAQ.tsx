...
const faqs = [
  {
    question: "Что такое умный и компьютерный стол и чем он отличается от обычного?",
    answer:
      "Умный и компьютерный стол — это стол из массива дуба с электрическим подъёмным механизмом: высоту можно менять одной кнопкой от 70 до 120 см. Это позволяет работать как сидя, так и стоя, снижая нагрузку на спину. Купить умный и компьютерный стол из дуба — значит получить и функциональность, и натуральную красоту дерева.",
  },
  {
